...
impl Vector4 {
    ...
    #[inline]
    pub fn from_x_yzw(x: f32, yzw: Vector3) -> Vector4 {
        Vector4::new(x, yzw.x, yzw.y, yzw.z)
    }
    #[inline]
    pub fn from_xy_zw(xy: Vector2, zw: Vector2) -> Vector4 {
        Vector4::new(xy.x, xy.y, zw.x, zw.y)
    }
    #[inline]
    pub fn from_xyz_w(xyz: Vector3, w: f32) -> Vector4 {
        Vector4::new(xyz.z, xyz.y, xyz.z, w)
    }

    #[inline]
    pub fn all(v: f32) -> Vector4 {
        Vector4::new(v, v, v, v)
    }
    ...
    pub fn normalized(self) -> Vector4 {
        self * (1f32 / Vector4::dot(self, self).sqrt())
    }
    #[inline]
    ...
    pub fn as_c_ptr(&self) -> *const f32 {
        self as *const Vector4 as *const f32
    }
    #[inline]
    pub fn as_c_mut_ptr(&mut self) -> *mut f32 {
        self as *mut Vector4 as *mut f32
    }
}
